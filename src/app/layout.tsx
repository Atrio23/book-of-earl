...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full antialiased">
      <body className="min-h-screen flex items-center justify-center p-2 sm:p-6 font-[family-name:var(--font-system)]">
        <BootWrapper>
          <div className="mac-window w-full max-w-6xl min-h-[85vh] flex flex-col overflow-hidden">
            <Header />
