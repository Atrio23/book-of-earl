...
export default function EmailCard({
  ...
  return (
    <Link
      href={`/email/${email.id}`}
      className={`group block px-4 py-3 sm:py-2 border-b border-[#ddd] transition-colors duration-100 ${
      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline justify-between gap-3">
            ...
            <time className="shrink-0 text-[12px] sm:text-[11px] text-[#888] font-[family-name:var(--font-system)] tabular-nums whitespace-nowrap">
